---
title: "How to Build a Wicking Bed in Australia: The Complete Guide"
date: 2026-02-11
description: "Learn how to build a wicking bed in Australia. IBC vs timber builds, costs, step-by-step instructions, best plants, and water savings for Aussie gardens."
tags: ["wicking beds", "water-efficient gardening", "DIY garden", "Australian gardening", "self-watering"]
...
1. **A waterproof container** — the outer shell that holds everything
2. **A water reservoir** — the bottom section filled with gravel or scoria (typically 200-300mm deep)
3. **An overflow outlet** — a pipe or hole that prevents waterlogging (critical!)
4. **Geotextile fabric** — separates the gravel from the soil so they don't mix
5. **Growing medium** — quality soil mix on top where your plants actually grow
