---
title: "Solar Battery Rebate Australia 2026: STCs, the Cheaper Home Batteries Program & What Changes in May"
date: 2026-02-11
description: "How to calculate your solar battery rebate in 2026. STCs explained, the May 2026 changes, worked examples, and why timing matters."
tags: ["solar battery", "STC rebate", "Cheaper Home Batteries", "off-grid", "renewable energy"]
categories: ["Solar"]
...
- 10 × 8.4 = **84 STCs**
- At $39 per STC = **$3,276 rebate**

For a 13.5kWh battery (like a Tesla Powerwall 2):
- 13.5 × 8.4 = **113.4 STCs** (rounded to 113)
- At $39 per STC = **$4,407 rebate**
...
- Meet Australian standards (AS/NZS 5139 for battery installation)
- Be a CEC-approved battery product
- Be connected to the grid (yes, even the "Cheaper Home Batteries" program requires grid connection for STC eligibility — fully off-grid systems have different rules)
...
- Battery capacity: 13.5kWh
- STC rate: ~6.5 per kWh (estimated)
- STCs earned: 13.5 × 6.5 = **88 STCs**
- STC value at $39 each: **$3,432**
...
- You've already decided on a battery and have quotes
- Your solar system is already installed and you're adding a battery
- You're looking at a battery of 15kWh or larger (the savings from the current rate are more significant)
- Your installer can realistically complete the installation and lodge the STC claim before May 2026

**Don't rush if:**
- You haven't done your homework on whether a battery is right for your situation
- You're being pressured by a salesperson using "the rebate is about to drop!" as a high-pressure sales tactic
- Your solar system isn't installed yet (get that right first)
- The battery you want is backordered and won't be installed in time anyway
...
- You're on a time-of-use tariff with a big difference between peak and off-peak rates
- You have a large solar system that exports a lot of cheap energy during the day
- Your feed-in tariff is low (5–8c/kWh) but your usage rate is high (30c+/kWh)
- You experience frequent blackouts and value backup power
- You're planning an off-grid or partial off-grid setup

If you're considering going off-grid or setting up a serious battery storage system, you'll need to think about more than just the rebate. System sizing, inverter compatibility, backup circuits, and load management all matter. I cover the full system design process in [Off-Grid but Online](/books/off-grid-but-online/), including how to size your battery bank, choose the right inverter configuration, and design a system that actually works year-round — not just in summer when the sun's blazing.
