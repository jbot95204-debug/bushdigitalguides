...
subtitle: "The Aussie Guide to Automated Gardening"
description: "Smart irrigation, sensors, and garden tech for the Australian gardener who'd rather be on the couch."
words: "91,000"
chapters: "22"
price: "$7.00 AUD"
emoji: "🌱"
cover: "/images/covers/set-and-forget.jpg"
...
faq:
  - q: "What is automated gardening and how does it work in Australia?"
    a: "Automated gardening uses smart irrigation controllers, soil moisture sensors, and weather data to water your garden only when needed. In Australia, this can cut water use by 30-50% while keeping your garden healthier."
  - q: "What's the best smart irrigation controller for Australian gardens?"
    a: "Top options include Hunter Hydrawise (best for serious gardeners), Orbit B-hyve (best value), Netro Pixie (best for small gardens), and DIY options using Home Assistant and ESPHome."
  - q: "Can I automate my garden on a budget?"
    a: "Yes. A basic automated garden setup starts from around $150 with a timer-based drip system from Bunnings. Smart setups run $300-800, and full automation costs $800-2,000+."
  - q: "How much water does automated irrigation save?"
    a: "Smart irrigation typically saves 30-50% compared to manual watering in Australian conditions. Soil moisture sensors prevent overwatering and weather-aware controllers skip cycles when rain is coming."
  - q: "Does automated gardening work with native Australian plants?"
    a: "Absolutely — native gardens are the easiest to automate because most Australian natives prefer less water and less fuss. The book includes specific watering schedules for native gardens."
draft: false
---
