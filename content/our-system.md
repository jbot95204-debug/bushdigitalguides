...
<section class="bdg-section">
  <div class="container bdg-split">
    ...
    <div class="bdg-message-card">
      ...
      <p>Free Review, Services, Our System, and Contact are live website paths.</p>
      <span class="bdg-label">Readiness path</span>
      <p>Google Business Profile setup, review-generation process, enquiry tracker, and follow-up SOP are prepared privately before any external setup or outreach.</p>
    </div>
  </div>
</section>

<section class="bdg-section bdg-form-section">
  <div class="container bdg-form-grid">
    ...
    <div class="bdg-form-card">
      ...
      <p>Email is the reliable starting point while we keep enquiry capture simple and verifiable.</p>
      <div class="bdg-stacked-actions">
        <a href="/free-review/" class="btn btn-primary">Get the Free Review →</a>
        <a href="/contact/" class="btn btn-outline">Contact Bush Digital Guides</a>
      </div>
    </div>
  </div>
</section>
