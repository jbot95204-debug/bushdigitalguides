...
GATES = (
    ...
    Gate('Images', 'Images have deliberate focal crops at every breakpoint, no distortion/blur, no empty strip and no competition with adjacent text.', 'Exact mobile/desktop image screenshots.', 'P0'),
    ...
    Gate('Bespoke BDG character', 'Deep-green/mineral/eucalyptus/ochre system feels calm, premium and practical for regional trade businesses; reject blue SaaS, gradients, glass cards, dashboard stats, fake proof and generic template decoration.', 'Art-direction review against actual rendered pages.', 'P0'),
)
